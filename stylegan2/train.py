    ...
    for idx in pbar:
        ...
        if g_regularize:
            ...
            if not args.use_label:
                ...
                label = torch.randint(0, generator.label_size, size=(path_batch_size,), device=device)
        ...
        if get_rank() == 0:
            ...
            if i > 0 and i % args.stop_after == 0:
                return 1
...
if __name__ == '__main__':
    ...
    discriminator = Discriminator(
        args.size, args.latent, channel_multiplier=args.channel_multiplier, use_label=args.use_label,
    ).to(device)
